...
# Package meta-data:
NAME = "bank2ynab"
DESCRIPTION = "Convert CSV files from various banks into YNAB's import " \
        "format."
LONG_DESCRIPTION = "bank2ynab is a common project to consolidate all " \
        "conversion efforts from various banks' CSV export formats into " \
...
# !! See https://github.com/torbengb/bank2ynab/wiki/VersionNumbers
